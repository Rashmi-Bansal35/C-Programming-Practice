...
| 3  | Use calloc to allocate and zero-initialize a char array for a sentence.                     | ✅       |
| 4  | Allocate memory for a Point struct with x and y, assign values, and free the memory.        | ✅       |
